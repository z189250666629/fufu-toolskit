...
func initDB(path string) (*sql.DB, error) {
	...
	if _, err := d.Exec(`CREATE UNIQUE INDEX IF NOT EXISTS cards_subscription_id_idx ON cards(subscription_id) WHERE subscription_id IS NOT NULL`); err != nil {
		return nil, err
	}
